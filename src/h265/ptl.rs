...
impl ProfileTierLevel {
  ...
  pub fn from_reader<R: Read>(
    ...
    if if_profile(4) || if_profile(5) || if_profile(6) || if_profile(7) || if_profile(8) || if_profile(9) || if_profile(10) || if_profile(11) {
    ...
    if if_profile(1) || if_profile(2) || if_profile(3) || if_profile(4) || if_profile(5) || if_profile(9) || if_profile(11) {
    ...
    for i in 0..max_num_sub_layers_minus1 {
      sub_layers[i as usize] = if sub_layer_profile_present_flags[i as usize] {
        ...
        let if_profile = |idc: u8| -> bool {
          sub_layer_profile_idc == idc || sub_layer_profile_compatibility_flags[idc as usize]
        };
